...
void start_menu(SDL_Renderer *renderer, ressources_t ressources, SDL_Event *event, SDL_Window *window, game_t *game)
{
    ...
    while (choix != -1)
    {
        ...
        case 2:
            ...
            str = "Quitter : 3";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) + 425, 500, TITLE_WIDTH - 200, TITLE_HEIGHT, str, ressources.font, 255, 0, 0);
            str = "0 : Retour";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) - 225, 500, TITLE_WIDTH - 200, TITLE_HEIGHT, str, ressources.font, 0, 0, 255);
            str = "Ce bloc est un mur.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) - 150, 210, TITLE_WIDTH / 2, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
            str = "L'eau vous ralentis.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) - 150, 310, TITLE_WIDTH / 2, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
            str = "La glace vous accelere.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) - 150, 410, TITLE_WIDTH / 2+50, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
            str = "Le sol vous est neutre.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) + 350, 210, TITLE_WIDTH / 2, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
            str = "Le magma vous blesse.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) + 350, 310, TITLE_WIDTH / 2, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
            str = "Le bloc de soin vous soigne.";
            apply_text(renderer, (SCREEN_WIDTH / 2 - TITLE_WIDTH / 2) + 350, 410, TITLE_WIDTH / 2+100, TITLE_HEIGHT / 2, str, ressources.font, 255, 255, 255);
